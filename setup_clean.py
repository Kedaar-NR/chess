#!/usr/bin/env python3
"""
Chess Engine Setup Script - Clean Version
...
def main():
    ...
    print("\nYou can now run:")
    print("  python run_chess_clean.py           # Basic chess engine test")
    print("  python chess_engine_clean.py        # Professional interface")
    print("  python bot_vs_bot_clean.py         # Bot vs Bot games")
