#!/usr/bin/env python3
"""
Bot vs Bot Chess Game - Clean Version

Two chess engines play against each other with optimal moves and professional visualization.
"""
...
def create_visual_board(board: chess.Board, last_move: Optional[chess.Move] = None, 
    ...
    """Create a professional visual ASCII chess board."""
    ...
    for i in range(8):
        ...
        for j in range(8):
            ...
            if is_last_move:
                ...
                bg = "+"  # Highlight for special squares
            elif is_light:
                bg = " "  # Light square
            else:
                bg = "·"  # Dark square
